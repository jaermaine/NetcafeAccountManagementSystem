<?php
    ...
    if ($pass != $details["user_password"]){
        ...
        case 1:
            echo "<script>window.location = '/NetcafeAccountManagementSystem/admin-page.php' </script>";
        case 2:
            echo "<script>window.location = '/NetcafeAccountManagementSystem/staff-page.php' </script>";
        case 3:
            echo "<script>window.location = '/NetcafeAccountManagementSystem/user-page.php' </script>";
        }
    }
